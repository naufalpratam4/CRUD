...
<body>
    ...
    <div class="container card mt-5" style="width: 500px"><label for="title" class="fw-bold fs-3 pt-3">Detail
        ...
        <div class="mb-3">
            ...
            <input type="text" name="Address" class="form-control" id="Address" value="<?php echo e($student->Address); ?>"
                readonly>
...
<?php /**PATH D:\College\semester 6\Magang\magangjogja\coba\resources\views/student/detail.blade.php ENDPATH**/ ?>