...
<body>
    ...
    <div class="container card mt-5" style="width: 500px">
        ...
        <div class="card-body">
            ...
            <form action="<?php echo e(route('password.edit')); ?>" method="post">
                <?php echo csrf_field(); ?>
                <div class="mb-3">
...
<?php /**PATH D:\College\semester 6\Magang\magangjogja\coba\resources\views/password/editPassword.blade.php ENDPATH**/ ?>